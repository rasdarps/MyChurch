...
// find out the number of results stored in database
    $sql="SELECT * FROM hymns WHERE category='english'";
...
$sql='SELECT * FROM hymns WHERE category="english" LIMIT ' . $this_page_first_result . ',' .  $page_rows;
$result = mysqli_query($conn, $sql);
...
<section>
    ...
    <!--<p class="textline"><?php //echo $textline1;?> &nbsp; / &nbsp; <?php //echo $textline2;?></p>-->
        ...
        ?>
        <div class="card mb-3 mx-auto" style="max-width: 540px; background:#00324E;">
